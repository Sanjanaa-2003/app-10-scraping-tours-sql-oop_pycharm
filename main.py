...
class Email:
    def send(self, message):    #self should be in every object of a class
        host = "smtp.gmail.com"
        port = 465
...
if __name__ == "__main__":
    while True:
        event = Event()  # Create object instance event for class Event
        ...
        if extracted != "No upcoming tours":
            ...
            if not row:
                ...
                email=Email()   #This is an instance of the Email class
